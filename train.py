...
class Train:
    def __init__(self,root):
        ...
        img_top = img_top.resize((1530,300))
        self.photoimg_top = ImageTk.PhotoImage(img_top)

        f_lbl1 = Label(self.root,image = self.photoimg_top)
        f_lbl1.place(x=0,y=70,width=1530,height = 300)

        #Button
        b7 = Button(self.root,text="Train Data",command=self.train_classifier,cursor="hand2",font=("times new roman",30,"bold"),bg="red",fg="white")
        b7.place(x=0,y=370,width=1530,height= 50)
        ...
        f_lbl1.place(x=0,y=420,width=1530,height = 370)
